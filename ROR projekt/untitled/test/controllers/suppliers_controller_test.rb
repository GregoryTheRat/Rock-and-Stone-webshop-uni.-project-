...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference("Supplier.count") do
      post suppliers_url, params: { supplier: { ar_kg: @supplier.ar_kg, km_ar: @supplier.km_ar } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { ar_kg: @supplier.ar_kg, km_ar: @supplier.km_ar } }
